...
const PROTECTED_PAGE_PATHS = ['/admin', '/settings'];
...
export async function middleware(req: NextRequest) {
  ...
  // Get all necessary session fields for auth/csrf checks.
  ...
  // Verify that the refresh token is not expired, and perform refresh only in the case that it expired.
  try {
